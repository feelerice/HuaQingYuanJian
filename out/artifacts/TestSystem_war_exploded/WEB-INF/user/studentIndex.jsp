...
<div class="header bg-main">
  ...
  <div class="head-l">
      ...
      <a class="button button-little bg-red" href="../../register.jsp"><span class="icon-power-off"></span> 退出登录</a>
  </div>
</div>
...
<div class="leftnav">
  ...
  <ul style="display:block">
    ...
    <li><a href="questionServlet?method=getPaperList&ranking=ranking" target="right"><span class="icon-caret-right"></span>成绩排名</a></li>
  </ul>
</div>
