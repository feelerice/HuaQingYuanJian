...
//成绩查询
    ...
    @Override
    public List<Grade> queryGradeAtPaper(String paper) {
        String sql="SELECT * FROM grade WHERE paper = ? ORDER BY score DESC";
        return template.query(sql,new BeanPropertyRowMapper<Grade>(Grade.class),paper);
    }
}
